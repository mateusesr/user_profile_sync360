...
<body class="bg-gray-50 min-h-screen flex flex-col">
    <div class="container mx-auto px-4 py-8 flex-1 flex flex-col items-center justify-center">
        <div class="w-full max-w-lg bg-white rounded-xl shadow-md border border-gray-200 p-8 animate-fade-in">
            <h1 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <i class="fa-solid fa-user-plus text-blue-600"></i> Criar Novo Perfil
            </h1>
            @if($errors->any())
            ...
            @endif
            <form id="profileForm" action="{{ url('user_profiles/new') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                <div>
                    <label class="block text-gray-700 font-medium mb-1" for="nome"><i class="fa-solid fa-user"></i> Nome</label>
                    <input name="nome" id="nome" type="text" class="input-form" placeholder="Nome completo" required minlength="3" />
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="idade" id="idade" type="number" class="input-form" placeholder="Idade" required min="1" max="120" />
                    ...
                    <div>
                        ...
                        <input name="estado" id="estado" type="text" class="input-form" placeholder="Estado" required minlength="2" maxlength="2" />
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input name="cidade" id="cidade" type="text" class="input-form" placeholder="Cidade" required />
                    ...
                    <div>
                        ...
                        <input name="bairro" id="bairro" type="text" class="input-form" placeholder="Bairro" required />
                ...
                <div>
                    ...
                    <input name="rua" id="rua" type="text" class="input-form" placeholder="Rua" required />
                ...
                <div>
                    ...
                    <textarea name="biografia" id="biografia" class="input-form" placeholder="Conte um pouco sobre você..." rows="3" required minlength="10"></textarea>
                ...
                <div class="flex gap-4 mt-6">
                    <button type="submit" id="btnSalvar" class="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl shadow-md hover:bg-blue-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300 relative">
    ...
    document.querySelectorAll('.input-form').forEach(el => {
        el.classList.add('w-full','rounded-lg','border','border-gray-300','px-3','py-2','focus:outline-none','focus:ring-2','focus:ring-blue-200','transition-all','duration-150','text-gray-800','bg-gray-50','placeholder-gray-400');
    });
    document.querySelectorAll('.input-form-file').forEach(el => {
        el.classList.add('block','w-full','text-sm','text-gray-500','file:mr-4','file:py-2','file:px-4','file:rounded-lg','file:border-0','file:text-sm','file:font-semibold','file:bg-blue-50','file:text-blue-700','hover:file:bg-blue-100');
    });
    // Validação JS
